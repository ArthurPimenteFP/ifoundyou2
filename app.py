...
def index():
    ...
    # ===================================================================
    # A partir daqui, sabemos que o método é POST (formulário enviado)
    # ===================================================================

    # --- Coleta dos dados do formulário ---
    # request.form é um dicionário que contém todos os campos enviados pelo formulário
    # .get('nome_do_campo', '') tenta obter o valor do campo; se não existir, retorna ''
    # Os nomes 'valor_conta', 'quantidade_pessoas' e 'percentual_gorjeta'
    # correspondem ao atributo "name" de cada <input> no HTML
    valor_conta = request.form.get('valor_conta', '')
    quantidade_pessoas = request.form.get('quantidade_pessoas', '')
    percentual_gorjeta = request.form.get('percentual_gorjeta', '')
